        ...
        <Col span={8}>
          <Card title="FTX 仓位">
            ...
            <Descriptions bordered column={1} size="small">
              ...
              <Descriptions.Item label="未实现盈亏">{ftx[6]}</Descriptions.Item>
              <Descriptions.Item label="保证金余额">{ftx[7]}</Descriptions.Item>
              <Descriptions.Item label="可用余额">{ftx[8]}</Descriptions.Item>
              <Descriptions.Item label="美元价值">{ftx[9]}</Descriptions.Item>
            </Descriptions>
            <Descriptions bordered column={1} size="small">
